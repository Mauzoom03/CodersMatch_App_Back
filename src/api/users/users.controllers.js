...
const register = async (req, res, next) => {
    try {
        ...
        await transporter.sendMail({
            from: '"CodersMatch Team" <//emisor>', // sender address
            to: `${req.body.email}`, // list of receivers
            subject:"Confirmación registro CodersMatch", // Subject line
...
module.exports = { register, login, logout, confirm,  newPassword, isAdmin, getUserByToken, patchUser, getAllUsers, getOneUser, deleteUser };